...
public class RsaKeysReaderTests extends RsaKeyAwareTest {
	...
	public void testThrowsSettingsExceptionForEmptyBytes() throws IOException {
		Exception e = expectThrows(SettingsException.class,
	...
	public void testThrowsNullPointerExceptionForNullBytes() {
		Exception e = expectThrows(NullPointerException.class, () -> RsaKeysReader.readRsaKeyPair(null, null));
		assertEquals("Pubic key hasn't been set", e.getMessage());
	...
	public void testThrowsSettingsExceptionForUnsupportedKey() throws Exception {
		...
		final Exception e = expectThrows(SettingsException.class,
				() -> RsaKeysReader.readRsaKeyPair(readPemContent(publicKeyPem), readPemContent(dsaPrivateKeyPem)));
		assertEquals("Couldn't generate RSA key pair", e.getMessage());
	}
