...
public class EncryptedRepository extends BlobStoreRepository {
	...
	protected BlobStore createBlobStore() throws Exception {
		return new EncryptedBlobStore(blobStorageRepository.blobStore(), new CryptoIO(encryptionDataCache
				.computeIfAbsent(settingsKey(metadata.settings()), this::createOrRestoreEncryptionData)));
	}
