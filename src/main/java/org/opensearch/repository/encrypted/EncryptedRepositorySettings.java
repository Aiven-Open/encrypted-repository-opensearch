...
class EncryptedRepositorySettings {
	...
	private static final DeprecationLogger DEPRECATION_LOGGER = DeprecationLogger
			.getLogger(EncryptedRepositorySettings.class);
	...
	public static final List<Setting<?>> REPOSITORY_SETTINGS = Collections
			.unmodifiableList(Arrays.asList(AZURE_PUBLIC_KEY, AZURE_PRIVATE_KEY, FS_PUBLIC_KEY, FS_PRIVATE_KEY,
					GCS_PUBLIC_KEY, GCS_PRIVATE_KEY, S3_PUBLIC_KEY, S3_PRIVATE_KEY));
